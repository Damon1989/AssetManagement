...
using AssetManagement.Sessions;
using AssetManagement.Web.Controllers.Results;
using AssetManagement.Web.Models;
using AssetManagement.Web.Models.Account;
...
{
    public class AccountController : AssetManagementControllerBase
    {
